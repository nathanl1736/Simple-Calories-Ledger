...
export const APP_VERSION = '2.0.0.19';

export const RELEASE_NOTES = [
  'Added custom food database JSON imports.',
  'Added Settings management for custom databases.',
  'Enabled custom database foods in Quick Picks search.'
];
